...
import { Sparkles, Calendar, Building2, Users, Send, CheckCircle2, ShieldCheck, Wallet, User, PhoneCall, HeartHandshake, ArrowLeft, ChevronRight } from 'lucide-react';

export default function RancangUmrahPage() {
    ...
    <div className="bg-gradient-to-b from-[#FAF7FC] via-white to-gray-50 dark:from-[#130724] dark:via-[#0B0514] dark:to-[#08030F] min-h-screen py-8 sm:py-16 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex items-center gap-2 text-xs font-bold text-gray-500 dark:text-purple-300/80">
          ...
          <span className="text-gray-900 dark:text-white">Rancang Umrah Mandiri</span>
        </div>
        ...
        {/* Full-Width Deep Purple Hero Section */}
            ...
            <div className="lg:col-span-6 space-y-6 sm:space-y-8 text-left">
              ...
              <div className="space-y-3.5 pt-1">
                ...
                <div className="flex items-start gap-3 bg-white/5 p-3.5 rounded-2xl border border-white/10">
                  ...
                  <div>
                    <h4 className="font-extrabold text-sm text-white">Bebas Pilih Bintang Hotel & Maskapai Direct</h4>
